...
const GREEN =  { r: 299, g: 255, b: 204};
const PINK =   { r: 51, g: 0, b: 25 };
...
const getSpawnDelay = () => {
	let spawnDelayMax=650;
	const spawnDelayMin = 250;
	const spawnDelay = spawnDelayMax - state.game.cubeCount * 3;
...
// Spark config
const sparkColor = 'rgba(100,200,255,.3)';
const sparkThickness = 2.2;
const airDragSpark = 0.1;
// Track pointer positions to show trail
const touchTrailColor = 'rgba(360,360,360,.62)';
const touchTrailThickness =2000;
